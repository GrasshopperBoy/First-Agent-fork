...
in-process or eventually via an MCP server. Without this explicit
convention, the inner loop now pinned by
[ADR-7](./ADR-7-inner-loop-tool-registry-contract.md) might have
